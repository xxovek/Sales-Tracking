...
function display_routes() {
  $.ajax({
    ...
    success:function(data){
      ...
      '</td><td class="actions text-center"><a  onClick="edit_route('+ (i+1) +','+ data[i]['RouteId'] +');"><i class="fa fa-pencil"></i></a><a onClick="remove_route('+ (i+1) +','+ data[i]['RouteId'] +');"><i class="fa fa-trash-o"></i></a></td></tr>');
    }
