		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
								...
								<div class="col-sm-2">
									<div class="form-group">
											<div class="checkbox-custom checkbox-default">
												<input type="checkbox"  name="ChangePass" id="ChangePass" onclick="showPassDiv();"/>
												<label for="ChangePass"><h5 style="font:bold">Change Password</h5></label>
											</div>
									</div>
								</div>
                  ...
                  <div class="col-sm-2">
											<div class="form-group">
												<input type="password" id="pwd" name="pwd" class="form-control" autocomplete="off" required style="display:none"/>
										  </div>
									</div>
							</div>
					...
					<footer class="panel-footer">
						...
						<span id="msg"></span>
							...
							<div class="col-sm-4">
								...
								<input type="submit" class="btn btn-primary" value="Update" name="salesmanid" id="salesmanid"/>
