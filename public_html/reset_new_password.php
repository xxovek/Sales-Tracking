				...
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						...
						<form id="reset" method="post">
							...
							<div class="form-group mb-lg">
								<div class="input-group input-group-icon">
									<input name="varifycode" type="text" id="varifycode" placeholder="Verification Code" class="form-control input-lg"  autocomplete="off" required/>
								</div>
							</div>
...
$("#reset").on("submit",function(e){
    ...
    $.ajax({
     url:"../src/password_update_reset",
     method:"POST",
		 dataType:"json",
     data:{emailid:email,pwd:password,varifycode:varifycode},
